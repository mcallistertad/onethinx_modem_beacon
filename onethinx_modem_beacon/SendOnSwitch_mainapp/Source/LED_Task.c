    ...
    for(;;)
    {
        ...
        if(rtosApiResult == pdTRUE)
        {
            ...
            switch(statusLedData.orangeLed)
            {
                ...
                /* Turn ON the LED */
                case LED_TURN_ON:
                    Cy_GPIO_Clr(P10_0_PORT, P10_0_PIN);
                ...
                /* Turn OFF the LED */
                case LED_TURN_OFF:
                    Cy_GPIO_Set(P10_0_PORT, P10_0_PIN);
                    /* Set the timer to idle mode */
                    StatusLedOrangeTimerUpdate(STATUS_LED_IDLE_INTERVAL);
                ...
                case LED_TIMER_EXPIRED:
                    ...
                    {
                        /* Toggle the LED */
                        Cy_GPIO_Inv(P10_0_PORT, P10_0_PIN);
                    }
                    ...
                    {
                    		/* command for red led during invalid state */
                    }
                    break;
            ...
            switch(statusLedData.redLed)
            {
                ...
                /* Turn ON the LED */
                case LED_TURN_ON:
                    Cy_GPIO_Clr(P11_5_PORT, P11_5_PIN);
                    /* Set the timer to idle mode */
                ...
                /* Turn OFF the LED */
                case LED_TURN_OFF:
                    Cy_GPIO_Set(P11_5_PORT, P11_5_PIN);
                    /* Set the timer to idle mode */
                    StatusLedRedTimerUpdate(STATUS_LED_IDLE_INTERVAL);
                ...
                case LED_TIMER_EXPIRED:
                    ...
                    {
                        /* Toggle the LED */
                        Cy_GPIO_Inv(P11_5_PORT, P11_5_PIN);
                    }
                    ...
                    {
                    		/* refresh command for orange LED during invalid state */
                    }
                    break;

                default:
                		/* invalid command for red LED received */
                    break;
            }
        }
...
void static StatusLedOrangeTimerCallback(TimerHandle_t xTimer)
{
    ...
    if(rtosApiResult != pdTRUE)
    {
        //("Failure! : Status LED - Sending data to Status LED "\
                         "queue",0u);
    }
}
...
void static StatusLedOrangeTimerStart(void)
{
    ...
    if (xTimer_StatusLedOrange != NULL)
    {
        ...
        {
        		/* orange LED timer init failed */
        }
    }
    else
    {
        //("Failure! : Status LED  - Orange LED Timer creation", 0u);
    }
}
...
void static StatusLedOrangeTimerUpdate(TickType_t period)
{
    ...
    if(rtosApiResult != pdPASS)
    {
    		/* orange LED timer updated failed */
    }
}
...
void static StatusLedRedTimerCallback(TimerHandle_t xTimer)
{
    ...
    if(rtosApiResult != pdTRUE)
    {
    		/* sending data to stat LED queue failed */
    }
}
...
void static StatusLedRedTimerStart(void)
{
    ...
    if (xTimer_StatusLedRed != NULL)
    {
        ...
        if(rtosApiResult != pdPASS)
        {
        		/* red LED timer init failed */
        }
    }
    else
    {
    		/* red LED timer creation failed */
    }
}
