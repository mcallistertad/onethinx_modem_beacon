 ...
 */
#define CY_BLE_CONN_COUNT                           (0x02u)
...
#define CY_BLE_GAP_BROADCASTER_COUNT                (0x01u)
...
#define CY_BLE_GAP_OBSERVER_COUNT                   (0x01u)
...
#define CY_BLE_GATT_DB_ATT_VAL_COUNT                (0x11u)

/** The size of the cy_ble_attValuesLen array */
#define CY_BLE_GATT_DB_ATT_VAL_LEN_COUNT            (0x03u)
...
#define CY_BLE_ADV_PKT_0_INDEXTX_POWER_LEVEL   (0x13u)
#define CY_BLE_ADV_PKT_0_INDEXSERVICE_UUID_16   (0x16u)
#define CY_BLE_ADV_PKT_0_INDEXSERVICE_DATA   (0x1Au)
...
#define CY_BLE_ADV_PKT_1_INDEXLOCAL_NAME   (0x03u)
#define CY_BLE_ADV_PKT_1_INDEXTX_POWER_LEVEL   (0x13u)
#define CY_BLE_ADV_PKT_1_INDEXSERVICE_UUID_16   (0x16u)
#define CY_BLE_ADV_PKT_1_INDEXSERVICE_DATA   (0x1Au)
#define CY_BLE_SCN_PKT_1_INDEXLOCAL_NAME   (0x00u)
#define CY_BLE_SCN_PKT_1_INDEXTX_POWER_LEVEL   (0x10u)
#define CY_BLE_SCN_PKT_1_INDEXSERVICE_UUID_16   (0x13u)
#define CY_BLE_SCN_PKT_1_INDEXSERVICE_DATA   (0x17u)
...
#define CY_BLE_OBSERVER_CONFIGURATION_0_INDEX   (0x01u)
...
<Configuration major="1" minor="1" device="PSoC6">
    <GeneralProperties>
        <Property id="ConnectionCount" value="2"/>
        <Property id="GapRolePeripheral" value="true"/>
        <Property id="GapRoleCentral" value="true"/>
        <Property id="GapRoleBroadcaster" value="true"/>
        <Property id="GapRoleObserver" value="true"/>
            ...
            <ProfileRoles>
                <ProfileRole type="Server">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{e088ccb2-3cb8-42ef-9dcd-b507fb65c448}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                                <Property id="IncludedServices" value="{efe5459b-0165-4f56-ae7b-df3419215b76}"/>
                            </ServiceProperties>
                            <Characteristics>
                                    ...
                                    <Fields>
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="Value" value="Safecility_OTX"/>
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{3bc6eb5b-4ed0-49e0-baf0-943965024eb1}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                                <Property id="IncludedServices" value="{efe5459b-0165-4f56-ae7b-df3419215b76}"/>
                            </ServiceProperties>
                            <Characteristics/>
                        ...
                        <Service type="org.bluetooth.service.immediate_alert">
                            <ServiceProperties>
                                <Property id="EntityID" value="{efe5459b-0165-4f56-ae7b-df3419215b76}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics>
                ...
                <ProfileRole type="Client">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{f5a3c542-b524-41bc-938d-0573dd473110}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics>
                                <Characteristic type="org.bluetooth.characteristic.gap.device_name">
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{84b70ce2-d657-49fe-a297-8078b1c7fda8}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics>
    ...
    <GAP>
        <General>
            ...
            <Property id="DeviceName" value="Safecility_OTX"/>
            <Property id="Appearance" value="0"/>
            <Property id="TxPowerLevelAdvScan" value="Pos_4"/>
            <Property id="TxPowerLevelConnection" value="Pos_4"/>
        ...
        <PeripheralConfigurations>
            <PeripheralConfiguration name="Peripheral configuration 0">
                ...
                <AdvertisementPacket>
                    ...
                    <Property id="ServiceUuid" value="{efe5459b-0165-4f56-ae7b-df3419215b76}"/>
                    <Property id="AdServiceData" value="true"/>
                    <Property id="ServiceData" value="{efe5459b-0165-4f56-ae7b-df3419215b76}"/>
                    <Property id="ServiceDataValue" value=""/>
                </AdvertisementPacket>
                <ScanResponsePacket>
                    <Property id="AdLocalName" value="true"/>
                    <Property id="LocalNameType" value="Complete"/>
        ...
        <CentralConfigurations>
            <CentralConfiguration name="Central configuration 0">
                <ScanProperties>
                    <Property id="ScanDiscoveryProcedure" value="General"/>
                    <Property id="ScanningState" value="Active"/>
                    <Property id="ScanFilterPolicy" value="AcceptAllAdvPackets"/>
                    <Property id="DuplicateFiltering" value="false"/>
                    <Property id="ScanFastWindow" value="30"/>
                    <Property id="ScanFastInterval" value="30"/>
                    <Property id="ScanFastTimeoutEnabled" value="true"/>
                    <Property id="ScanFastTimeout" value="30"/>
                    <Property id="EnableReducedScan" value="true"/>
                    <Property id="ScanReducedWindow" value="1125"/>
                    <Property id="ScanReducedInterval" value="1280"/>
                    <Property id="ScanReducedTimeoutEnabled" value="true"/>
                    <Property id="ScanReducedTimeout" value="150"/>
                </ScanProperties>
        ...
        <BroadcasterConfigurations>
            <BroadcasterConfiguration name="Broadcaster configuration 0">
                <AdvertisementProperties>
                    <Property id="AdvDiscoveryMode" value="NonDiscoverable"/>
                    <Property id="AdvType" value="Scannable"/>
                    <Property id="AdvFilterPolicy" value="ScanRequestAnyConnectRequestAny"/>
                    <Property id="AdvChannelType" value="All"/>
                    <Property id="AdvFastScanIntervalMin" value="20"/>
                    <Property id="AdvFastScanIntervalMax" value="30"/>
                ...
                <AdvertisementPacket>
                    ...
                    <Property id="ServiceData" value="{efe5459b-0165-4f56-ae7b-df3419215b76}"/>
                    <Property id="ServiceDataValue" value=""/>
                    <Property id="ServiceDataCustom0" value=""/>
                    <Property id="ServiceDataCustom1" value=""/>
                    <Property id="ServiceDataCustom2" value=""/>
                    <Property id="ServiceDataCustom3" value=""/>
                    <Property id="ServiceDataCustom4" value=""/>
                    <Property id="ServiceDataCustom5" value=""/>
                </AdvertisementPacket>
                <ScanResponsePacket>
                    <Property id="AdLocalName" value="true"/>
                    <Property id="LocalNameType" value="Complete"/>
        ...
        <ObserverConfigurations>
            <ObserverConfiguration name="Observer configuration 0">
                <ScanProperties>
                    <Property id="ScanDiscoveryProcedure" value="NonDiscoverable"/>
                    <Property id="ScanningState" value="Active"/>
                    <Property id="ScanFilterPolicy" value="AcceptAllAdvPackets"/>
                    <Property id="DuplicateFiltering" value="false"/>
                    <Property id="ScanFastWindow" value="30"/>
